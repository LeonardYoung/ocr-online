        ...
        <a-row type="flex" justify="space-around">
            ...
            <a-col span="11" class="image-area">
                ...
                <div v-else-if="resultShow===2" class="result-box"  v-bind:style="{ minHeight: resultBoxHeight + 'px' }">
                    <canvas id="result-canvas" ref="resultCanvas" :style="previewCanvasStyle"
                            :height="canvasHeight + 'px'" :width="canvasWidth + 'px' "></canvas>
                </div>
        ...
        methods:{
            ...
            paintResult(result){
                ...
                let previewCtx=document.getElementById('preview-canvas')
                    .getContext("2d");
                let resultCtx=document.getElementById('result-canvas')
                    .getContext("2d");
                // let previewCtx=c.getContext("2d");

                // c = document.getElementById('result-canvas')
                // let resultCtx = c.getContext("2d")
                ...
                img.onload = function(){
                    ...
                    that.$nextTick(()=>{
                        ...
                        for(let one of result){
                            ...
                            _this.paintRectangle(resultCtx,one.text_box_position)
                            _this.drawText(resultCtx,one)
                        }
                    })
